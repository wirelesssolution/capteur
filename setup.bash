...
wget -q -O /etc/openhabian.conf  https://raw.githubusercontent.com/wirelesssolution/capteur/openhabian.conf.dist
...
wget -q -O /etc/openhab2/scripts/cron.sh https://raw.githubusercontent.com/wirelesssolution/capteur/scripts/cron.sh
sudo /bin/chmod 755 /etc/openhab2/scripts/cron.sh 
cronjob="*/1 * * * * /etc/openhab2/scripts/cron.sh"
(crontab -u root -l; echo "$cronjob" ) | crontab -u root -

wget -q -O /etc/openhab2/services/addons.cfg  https://raw.githubusercontent.com/wirelesssolution/capteur/services/addons.cfg
